...
public class CowBugImpl implements Cow{
	...
	public void TurnL() {
		...
		if(Face()== Dir.E) { dir = Dir.W ; return; }
		if(Face()== Dir.W) { dir = Dir.E ; return; }
	...
	public void TurnR() {
		...
		if(Face()== Dir.N) { dir = Dir.N ; return; }
		if(Face()== Dir.S) { dir = Dir.S ; return; }
