...
public class KeyTest {
	...
	@Test
	public void TestKeyInitPositif() {
		
		//Tester les differents constructeurs ( pré et post )
	
		Key k = new KeyImpl();
		Key f = new KeyContract(k);
		...
		assertTrue(f.row()==0);
		assertTrue(f.col()==0);
		assertTrue(f.Door_col()==1);
		assertTrue(f.Door_row()==1);
		...
		assertTrue(f.Door_col()==1);
		assertTrue(f.Door_row()==1);
		assertTrue(env.CellContent(0, 1)==k);
		...
		assertTrue(f.Door_col()==1);
		assertTrue(f.Door_row()==1);
		assertTrue(env.CellContent(1, 1)==k);	
	...
	@Test
	public void TestKeyInitNegatif() {
